...
import net.mcreator.perplayeritem.item.Disc6Item;
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				Perplayeritem1Mod.LOGGER.warn("Failed to load dependency world for procedure D6di!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				Perplayeritem1Mod.LOGGER.warn("Failed to load dependency x for procedure D6di!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				Perplayeritem1Mod.LOGGER.warn("Failed to load dependency y for procedure D6di!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				Perplayeritem1Mod.LOGGER.warn("Failed to load dependency z for procedure D6di!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				Perplayeritem1Mod.LOGGER.warn("Failed to load dependency entity for procedure D6di!");
			return;
		}
		...
		if (Perplayeritem1ModVariables.MapVariables.get(world).d6 == 1) {
			if ((entity.getCapability(Perplayeritem1ModVariables.PLAYER_VARIABLES_CAPABILITY, null)
					.orElse(new Perplayeritem1ModVariables.PlayerVariables())).d6p == 1) {
				if (((Entity) world
					...
					if ((new Object() {
						public ItemStack entityToItem(Entity _ent) {
							...
							}.compareDistOf(x, y, z)).findFirst().orElse(null)))).getItem() == Disc6Item.block) {
						{

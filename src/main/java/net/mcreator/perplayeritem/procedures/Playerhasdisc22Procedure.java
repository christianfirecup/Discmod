...
public class Playerhasdisc22Procedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				Perplayeritem1Mod.LOGGER.warn("Failed to load dependency world for procedure Playerhasdisc22!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				Perplayeritem1Mod.LOGGER.warn("Failed to load dependency entity for procedure Playerhasdisc22!");
			return;
		}
			...
			if (Perplayeritem1ModVariables.MapVariables.get(world).d22 == 1) {
				if ((entity instanceof PlayerEntity) ? ((PlayerEntity) entity).inventory.hasItemStack(new ItemStack(Disc22Item.block)) : false) {
					if (entity instanceof PlayerEntity) {
						ItemStack _stktoremove = new ItemStack(Disc22Item.block);

...
public class Disc30Item extends Perplayeritem1ModElements.ModElement {
	@ObjectHolder("perplayeritem1:disc_30")
	public static final Item block = null;

	public Disc30Item(Perplayeritem1ModElements instance) {
		super(instance, 119);
	}

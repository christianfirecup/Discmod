...
import net.mcreator.perplayeritem.procedures.Disc14pickupProcedure;
...
public class Disc14Item extends Perplayeritem1ModElements.ModElement {
	@ObjectHolder("perplayeritem1:disc_14")
	public static final Item block = null;

	public Disc14Item(Perplayeritem1ModElements instance) {
		super(instance, 55);
	}

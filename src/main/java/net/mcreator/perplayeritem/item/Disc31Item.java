...
public class Disc31Item extends Perplayeritem1ModElements.ModElement {
	@ObjectHolder("perplayeritem1:disc_31")
	public static final Item block = null;

	public Disc31Item(Perplayeritem1ModElements instance) {
		super(instance, 123);
	}

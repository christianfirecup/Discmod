...
import net.mcreator.perplayeritem.procedures.PlayerpickupProcedure;
...
public class Disc1Item extends Perplayeritem1ModElements.ModElement {
	@ObjectHolder("perplayeritem1:disc_1")
	public static final Item block = null;

	public Disc1Item(Perplayeritem1ModElements instance) {
		super(instance, 4);
	}
